...
export default {
    ...
    methods: {
        ...
        fetchData: function()
        {
            ...
            axios.get(api_url + '/api/attempt', headers)
            .then(function (res) {
                // handle success
                vm.items = res.data
            })
        ...
        fetchInitData: function()
        {
            ...
            axios.get(api_url + '/api/department', headers)
            .then(res => {
                vm.departments = res.data
            })

            // Fetch Roles Data
            axios.get(api_url + '/api/role', headers)
            .then(res => {
                vm.roles = res.data
            })
        },
